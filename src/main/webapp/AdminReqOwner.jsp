...
<center><h1>Owners Requests</h1></center><br>
<center><h4><a href="http://localhost:8080/Project/existingOwners.jsp">Existing Owners</a></h4></center>
...
<sql:query dataSource="${ds}" var="rs">SELECT * FROM `ownerrequest` where RequestStatus = "NO";</sql:query>
<br>
<div class="container">
<table class="table">
<tr>
	...
	<td><b><h4>Number</h4></b></td>
</tr>

<c:forEach items="${rs.rows}" var="row">
<tr>
	<td><c:out value="${row.OwnerId}"></c:out></td>
	<td><c:out value="${row.OwnerName}"></c:out></td>
	<td><c:out value="${row.OwnerMailID}"></c:out></td>
	<td><c:out value="${row.OwnerNumber}"></c:out></td>
	<td>		
	<form action="approve.jsp">
		<input type="hidden" name="id2" value="${row.OwnerId}">
		<input type="hidden" name="id1" value="${row.OwnerName}">
...
<div id="myDIV1" style=" display: none">
    <jsp:include page="AddOwner.jsp"></jsp:include>
    </div>
  <!-- FOOTER 
